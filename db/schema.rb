...
ActiveRecord::Schema.define(version: 20160519114213) do
  ...
  create_table "search_results", force: :cascade do |t|
    t.string   "record_string", limit: 255
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean  "share_gps",                          default: true
  end
  ...
  add_foreign_key "posts", "achievements"
